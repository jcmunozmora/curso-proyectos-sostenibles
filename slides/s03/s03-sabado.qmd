...
## Herramientas de IA para el flujo de caja {.smaller background-color="#f5f5f5"}
...
## Gobernanza de IA · la memoria del modelo {.smaller background-color="#f5f5f5"}
...
::: {.columns}
::: {.column width="52%"}
**Qué contiene** · plantilla: [Memoria del modelo](../../plantillas/07-memoria-del-modelo.html)
