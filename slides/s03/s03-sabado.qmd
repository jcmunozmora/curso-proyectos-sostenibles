...
| Fórmula de hoy | ¿En las lecturas? | Fuente exacta |
|---|---|---|
| **FCLD y FCA** (construcción de los dos flujos) | 🏛 | Sapag, caps. 14–15 (6ª ed., biblioteca) — la lectura `02b` fue solo el cap. 6 |
| **TIR** · $\sum FC_t/(1+TIR)^t = 0$ | 🏛 + ✅ | Definición: Sapag cap. 15 · la crítica — *"eviten VPN/TIR si hay comparables"* — Welch, lectura `03b`, sugerencia #1 |
| **Supuesto de reinversión** (el álgebra) | 🧑‍🏫 | Derivación de clase — hace explícito lo que Sapag y Welch afirman sin demostrar |
| **Regla de los signos de Descartes** | 🧑‍🏫 | Matemática clásica (1637); no está en las lecturas |
| **TIRM** | 🧑‍🏫 | **No está en Sapag 6ª ed. ni en las lecturas** — referencia estándar: Brigham & Ehrhardt (biblioteca EAFIT) |
| **Payback descontado** | 🏛 | Sapag cap. 15 — lo llama *periodo de recuperación* |
| **CAE** · `=PAGO(tasa; n; −VPN)` | 🏛 | Sapag cap. 15 |
| **Índice de rentabilidad** · $VPN/I_0$ | 🏛 | Sapag cap. 15 — lo llama **IVAN** |
| **Punto de equilibrio** · $Q^* = CF/(p-cv)$ | ✅ **Ya la leyeron** | Lectura `02b` — Sapag cap. 6, §6.10 *análisis costo-volumen-utilidad* |
| **GAO / GAF** | 🧑‍🏫 | No están en Sapag 6ª ed. — referencia estándar: Brigham & Ehrhardt (biblioteca) |

::: {.callout-note}
Dos brechas honestas: **TIRM** y **GAO/GAF** no tienen lectura de respaldo en este curso — se enseñan en clase porque el proyecto los necesita (flujo no convencional + 60% de deuda). Quien quiera la fuente completa: Brigham & Ehrhardt, *Financial Management*, biblioteca EAFIT.
:::
