...
✅ está en una lectura asignada · 📖 texto base OA, capítulo **no** asignado · 🧑‍🏫 se enseña en clase, sin lectura de respaldo — brecha **declarada**, no escondida

| Fórmula de esta noche | ¿En las lecturas? | Fuente exacta |
|---|---|---|
| **CAPM** · $E[R_i] = R_f + \beta(E[R_m]-R_f)$, $\beta = \mathrm{Cov}/\mathrm{Var}$ | ✅ Welch la presenta — y la demuele | Welch (2021), lectura `03b` (*primer* + Figura A) · formalización completa: texto base §12.4 (OA) |
| **$K_e$ con prima país** · $R_f + \beta \cdot ERP + \text{prima país}$ | ⚠️ En **ninguna** lectura como fórmula: es práctica de mercado | Método y datos: tabla de Damodaran (la que bajan en vivo) · Welch, lectura `03b`, explica por qué es un parche sin teoría |
| **WACC** · $\tfrac{E}{V}K_e + \tfrac{D}{V}K_d(1-t)$ | 📖 Capítulo no asignado | Texto base §13.1.3 *Weighted Average Cost of Capital* (OA) |
| **Fisher / conversión de moneda** · $(1+i_{COP}) = (1+i_{USD})\tfrac{1+\pi_{COP}}{1+\pi_{USD}}$ | 🧑‍🏫 Solo clase | Estándar de finanzas internacionales; la derivación completa quedó en la slide de Teoría |

::: {.callout-note}
Que una fórmula no esté en las lecturas **no es un descuido**: las dos lecturas de hoy no enseñan la mecánica — discuten **si estas fórmulas merecen la confianza que se les tiene** (Welch) y **qué tan poco acuerdo hay incluso entre expertos sobre la tasa** (Drupp). La mecánica viene de los textos de referencia; el **criterio** viene de las lecturas. Por eso son las lecturas.
:::
