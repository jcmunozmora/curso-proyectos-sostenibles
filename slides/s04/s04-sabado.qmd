...
::: {.callout-note}
La lógica que ya aprendieron esta mañana **no cambió**: con proyecto vs. sin proyecto, la diferencia es el balance, Tier 1 por defecto y Tier 2 si hay datos propios. Lo que cambió es la plataforma y el detalle metodológico detrás — más riguroso, no distinto.
:::
...
→ Es exactamente lo que van a ver con Inditex: datos usables sólo para emisiones, y ni siquiera completos.
:::
...
::: {.notes}
1 min. Nombrar los dos retos con las palabras exactas del libro: "practical challenge" (datos) y "mental challenge" (la disposición a pensar así). Es la frase que conecta toda la sesión, desde el salario sombra hasta Inditex.
:::
...
::: {.notes}
2 min. Este mapa es lo que debió pasar ANTES de calcular el excedente del consumidor y el bienestar del empleado — es el paso 1 (materialidad) que la siguiente slide aplica sin volver a nombrarlo. Cerrar el círculo: por qué esos dos factores, y no otros, fueron los elegidos para Inditex.
:::
...
::: {.callout-note}
**¿De dónde salen estos precios sombra?** Del apéndice del cap. 5 (§A.1), que a su vez cita dos bases: **Impact Economy Foundation** y **[True Price](https://www.trueprice.org/resources/)** — la organización que mantiene la lista de factores de monetización más usada en la práctica. Si en la Construcción 1 necesitan un precio sombra que no está en el apéndice (agua, biodiversidad, salud), **ese es el sitio para buscarlo primero.**
:::
...
Shadow prices no es la única convención para el paso 3 (monetización). **SROI** (*Social Return on Investment*, el estándar de Social Value International) es la otra que van a encontrar en la práctica — sobre todo si trabajan con una ONG o un fondo de impacto.
...
| Ajuste | Qué pregunta | Ya lo vieron como… |
|---|---|---|
| **Deadweight** | ¿Habría pasado esto de todas formas, sin el proyecto? | La **adicionalidad** del carbono (viernes/hoy) |
...
## Profundización opcional · el espejo nacional de Inditex {background-color="#000066" style="color:white;"}
...
::: {.notes}
Opcional — si el tiempo apremia, saltar directo a Construcción 1. Sirve mejor como lectura entre sesiones o como insumo para el equipo que quiera un caso nacional en su Nota de Inversión de S5.
:::
...
::: {.notes}
2 min. Cierre del bloque opcional: esto es "el reto práctico" de la slide de esta mañana, visto con datos colombianos reales en vez de una frase abstracta. Si hay tiempo, preguntar: "¿quién tendría que publicar qué, para que este número dejara de ser un mínimo?" — no hay que responderla, sólo dejarla sobre la mesa.
:::
...
::: {.callout-tip}
**¿No encuentran el precio sombra que necesitan?** [True Price](https://www.trueprice.org/resources/) es la fuente detrás de la tabla del apéndice de Schoenmaker (cap. 5, §A.1) — el primer sitio para buscar un factor que no esté ahí.
:::
