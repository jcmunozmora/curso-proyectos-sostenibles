...
::: {.notes}
1.5 min. Este es el cierre real del "menú" de metodologías de la Sección 4 — no es para memorizar las tres nuevas, es para que sepan que existen y dónde ubicarlas cuando las encuentren en la práctica. El puente más útil: "si su empresa ya hace un Balance Social, no empiezan de cero — ya tienen la mitad del trabajo (cuantificación); les falta el paso de monetización que vieron hoy." El IMI es material de autoría propia (Centro de Valor Público EAFIT / Valoria) — mencionarlo con naturalidad, no como autopromoción forzada. Fuente: @andioit1987balancesocial (Balance Social); @boardman2018 (Valor Económico Total — capítulo de valoración de bienes ambientales sin mercado; [PV] confirmar número exacto de capítulo en la 5ª ed.); @imi_valorpublico_eafit (IMI).
:::
...
## Sección 5 · El mercado, hoy {background-color="#000066" style="color:white;"}
...
::: {.notes}
30 seg. Transición pura, sin contenido nuevo todavía. El mensaje: "lo que construyeron con las manos hoy es el mismo lenguaje que usa el capital global." Sirve de puente hacia el Investor Day: el comité de inversión de la próxima sesión piensa exactamente en estas categorías.
:::

---

## Panorama · una brecha de billones, 37 respuestas {.smaller}
...
::: {.notes}
1 min. El objetivo de esta slide es una sola cifra que se quede: la brecha es de billones, no de millones. La nota sobre "trillion" vs. "billón" no es trivia idiomática — es el mismo tipo de error de unidades que se les exige declarar desde S3. Fuente: @wef2025naturefinance, resumen ejecutivo e introducción.
:::

---

## Teoría · la misma rúbrica que ya usan ustedes, aplicada al mundo {.smaller}
...
::: {.notes}
1.5 min. Conectar explícitamente: esta rúbrica es un ejercicio de costo-beneficio aplicado a la elección de *instrumentos*, no a un proyecto — mismo principio metodológico de todo el curso. Fuente: @wef2025naturefinance, Recuadro 2 y Anexo A (tabla completa de criterios).
:::

---

## El mapa · las 10 soluciones que superan el corte {.smaller}
...
::: {.notes}
1.5–2 min. No leer la tabla completa en clase: señalar sólo las tres resaltadas y decir "esas ya las vieron". El resto queda como referencia en Interactiva para quien quiera profundizar. Fuente: @wef2025naturefinance, resumen ejecutivo (definiciones) y Figura 4 (tamaños de mercado).
:::

---

## Cierre · el mapa mundial ya tiene los nombres que vieron hoy {.smaller background-color="#f5f5f5"}
...
|---|---|---|
| **Créditos ambientales** | *El Globo* (Terrasos), Colombia — primer proyecto voluntario de créditos de biodiversidad del país, 340 ha de bosque de niebla | El banco de hábitat en Támesis, verificado por KPMG [@terrasos_elglobo] |
| **Fondos de impacto** | Mirova LDN Fund, USD 208 M — capital paciente para agricultura y silvicultura sostenible en mercados emergentes | Su **primera inversión**: el fondo Urapi/RioSierra en la Sierra Nevada de Santa Marta — café, cacao y miel [@urapi_ldn] |
| **Precio interno a la naturaleza** | Emergente, sin esquemas activos todavía según el reporte | Kering ya lo hace desde 2011 con su EP&L — la fuente de precios sombra que usaron hoy [@kering_epl] |
...
::: {.notes}
1.5 min. Este es el cierre real del contenido del día — dejarlo respirar, no correr hacia Gobernanza de IA de inmediato. El punto no es "miren qué interesante" sino "el estándar que les exigimos — declarar supuestos, citar fuente, verificar — es literalmente el estándar que un comité de inversión global usa para decidir qué financiar". Puente directo al Investor Day: el comité de la próxima sesión actúa exactamente así. Fuente: @wef2025naturefinance, Recuadro 7 (créditos ambientales) y Recuadro 10 (fondos de impacto); cruce con @terrasos_elglobo, @urapi_ldn y @kering_epl, ya citados en sesiones anteriores.
:::
...
::: {style="text-align:center; font-size:1.3em; color:#000066; font-weight:700; margin-top:8px;"}
