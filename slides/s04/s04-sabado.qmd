...
| Ajuste | Qué pregunta | Ya lo van a ver como… |
|---|---|---|
| **Deadweight** | ¿Habría pasado esto de todas formas, sin el proyecto? | La **adicionalidad** del carbono (sección de valor ambiental) |
...
::: {.notes}
2 min. El puente más fuerte es deadweight = adicionalidad: mismo concepto, dos nombres, dos campos (carbono vs. social). Si un equipo ya domina adicionalidad, SROI les va a parecer obvio. Drop-off y desplazamiento sí son nuevos — no forzar más ejemplos, con el de capacitación alcanza.
:::
...
Antes de la fórmula, la idea con un ejemplo de bolsillo: si están dispuestos a pagar hasta **$15.000** por un almuerzo y sólo les cobran **$10.000**, su excedente son esos **$5.000** — el bienestar que se llevan gratis. Sumado sobre todos los clientes, es el área bajo la curva de demanda y sobre el precio de equilibrio: un **triángulo**.

$$\text{Excedente} = \underbrace{\Delta P}_{\text{lo que "ahorra" cada cliente}} \times \underbrace{Q}_{\text{cuántos clientes}} \times \frac{1}{2}$$

**El problema:** nadie observa $\Delta P$ (el precio máximo que alguien habría pagado). La salida: la **elasticidad-precio** ($\varepsilon$) describe la misma curva de demanda sin necesitar ese dato — y con ella, ventas y elasticidad bastan:

$$\text{Excedente} = \frac{\text{Ventas}}{\varepsilon} \times \frac{1}{2}$$

::: {.callout-important}
**La intuición que hay que quedarse:** a **menor** elasticidad (un producto sin buenos sustitutos), **mayor** excedente por cada peso de ventas — porque a la gente le cuesta más renunciar a él, y estaría dispuesta a pagar mucho más de lo que paga.
:::

::: {.notes}
2 min. Esta slide no estaba en la versión anterior del curso — es la explicación intuitiva que faltaba antes de mostrar la fórmula fría. No apurar el paso del triángulo a la fórmula de elasticidad; es el salto conceptual que más cuesta.
:::
...
::: {.notes}
2 min. Cierre de la intuición: la comparación entre Inditex y Frisby no es sólo repetir los números — es mostrar que la fórmula responde de forma predecible a la elasticidad, y que eso es economía básica (sustitutos), no una caja negra. Puente a la Construcción 1: van a tener que elegir su propia elasticidad o su propio precio sombra para "una externalidad más".
:::
