...
## Criterios de decisión del comité {.smaller}
...
## Las preguntas que el comité va a hacer {.smaller data-cron="720" data-cron-label="interrogatorio"}
...
## La tarjeta de co-evaluación {.smaller data-cron="1200" data-cron-label="co-evaluación"}
...
## Cómo se calcula, y las salvaguardas {.smaller}
